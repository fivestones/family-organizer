...
**Phase 4 — polish:** ~~rotation pause/history semantics~~ **completed 2026-07-15**; ~~countdown golden scenarios (5.2)~~ **completed 2026-07-15**; rotation transparency, claim flow, backfill, joint-chore XP decision.
