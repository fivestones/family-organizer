...
- **Completed 2026-07-15:** card attachment removal now uses the shared accessible alert-dialog treatment, identifies the file, and waits for a successful delete before closing; cancellation performs no write.
